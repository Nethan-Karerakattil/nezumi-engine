...
/* Variables */
let translation = [0, 0, -100];
let rotation = [util.deg_to_rad(180), util.deg_to_rad(150), util.deg_to_rad(170)];
let scale = [4, 4, 4];
...
main();
async function main() {
	const file = await (await fetch("./src/assets/scenes/obj/teapot.obj")).text();
	positions = loadWaveFront(file);
